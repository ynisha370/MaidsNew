        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="text-left mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Sign in to your cleaner account to manage jobs and earnings
            </p>
          </div>
            ...
            <CardContent>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <Button
                  ...
                  size="sm"
                  className="mt-2"
                  onClick={() => setFormData({ email: 'cleaner@maids.com', password: 'cleaner@123' })}
                >
            ...
            <div className="mt-6">
              ...
              <div className="mt-4">
                <Button
                  ...
                  onClick={() => navigate('/cleaner/signup')}
                >
              ...
              <div className="mt-4">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full btn-hover border-gray-300 text-gray-600 hover:bg-gray-50"
