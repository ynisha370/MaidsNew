...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo 3. Extract to C:\src\flutter
    echo 4. Add C:\src\flutter\bin to system PATH
...
REM Check for Flutter app directory
...
echo.
set /p confirm=Do you want to launch the app now? (y/n): 
if /i not "%confirm%"=="y" (
    echo Cancelled.
    cd ..
    pause
